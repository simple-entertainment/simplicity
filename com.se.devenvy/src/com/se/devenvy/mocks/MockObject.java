...
public abstract class MockObject
{
	 ...
	 * @param parameters The parameters passed to this <code>MockObject</code> when the method was called, or <code>null</code>
	...
	protected boolean parametersEqual(Object[] parameterSetA, Object[] parameterSetB)
	{
		...
		{
			if (!parameterSetA[index].equals(parameterSetB[index]))
			{
				return (false);
			}
		}
	 ...
	 * </p>
	 * 
	 * @param beforeCallIndex The index of the call to the method that is expected to have come before (the nth call). The first
	 * call is index 0.
	 * @param beforeMethodName The method that is expected to have been called before.
	 * @param afterCallIndex The index of the call to the method that is expected to have come after (the mth call). The first
	 * call is index 0.
