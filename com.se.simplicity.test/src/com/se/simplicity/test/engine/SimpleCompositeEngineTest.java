...
public class SimpleCompositeEngineTest
{
	 ...
	 * <p>
	 * Unit test the method {@link com.se.simplicity.engine.SimpleCompositeEngine.getCompositeFrequency getCompositeFrequency()}
	 * with the special condition that the {@link com.se.simplicity.engine.SimpleCompositeEngine SimpleCompositeEngine} being
	 * tested does not have any sub-engines.
	 * </p>
	 */
	@Test
	 ...
	 * </p>
	 * 
	 * @throws InterruptedException If the test is interrupted while it is waiting for the
	 * {@link com.se.simplicity.engine.SimpleCompositeEngine SimpleCompositeEngine} to run.
	 */
	@Test
	...
	/**
	 * <p>
	 * Unit test the method {@link com.se.simplicity.engine.SimpleCompositeEngine.run run()} with the special condition that one
	 * of the sub-engines runs longer than is allowed by its preferred frequency.
	 * </p>
	 * 
	 * @throws InterruptedException If the test is interrupted while it is waiting for the
	 * {@link com.se.simplicity.engine.SimpleCompositeEngine SimpleCompositeEngine} to run.
