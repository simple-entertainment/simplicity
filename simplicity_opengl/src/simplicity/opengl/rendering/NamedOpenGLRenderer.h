...
namespace simplicity
{
  namespace opengl
  {
    /**
     * <p>
     * This implementation names the <code>Model</code>s rendered as well as the primitives rendered (faces, edges or vertices). <code>Model</code>s
     * are named using their hash codes unless a specific name is given. The naming of the primitives is specific to the <code>Model</code>
     * implementation.
     * </p>
     *
     * @author Gary Buyn
    ...
    class NamedOpenGLRenderer : public NamedRenderer
    {
      ...
      private:
         ...
         */
        void
        renderVectorVGEdges(const VectorVG& vertexGroup);
         ...
         */
        void
        renderVectorVGFaces(const VectorVG& vertexGroup);
         ...
         */
        void
        renderVectorVGVertices(const VectorVG& vertexGroup);
    };
  }
}
