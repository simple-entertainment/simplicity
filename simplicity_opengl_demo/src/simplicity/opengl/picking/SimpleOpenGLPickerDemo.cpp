...
namespace simplicity
{
  namespace opengl
  {
    ...
    void
    SimpleOpenGLPickerDemo::dispose()
    {
      fEngine.destroy();
    }

    string
    SimpleOpenGLPickerDemo::getDescription()
    {
    ...
    shared_ptr<Node>
    SimpleOpenGLPickerDemo::getCameraRootNode()
    {
      return (fRenderingEngine->getCamera()->getNode()->getParent());
    }

    string
    SimpleOpenGLPickerDemo::getTitle()
    {
      return ("SimpleOpenGLPicker");
    }

    void
    SimpleOpenGLPickerDemo::init()
    {
    ...
    void
    SimpleOpenGLPickerDemo::mouseClick(const int x, const int y)
    {
    ...
    void
    SimpleOpenGLPickerDemo::operator()(const PickEvent& event) const
    {
