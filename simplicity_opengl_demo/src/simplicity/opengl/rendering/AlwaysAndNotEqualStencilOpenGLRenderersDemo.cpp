...
namespace simplicity
{
  namespace opengl
  {
    ...
    void
    AlwaysAndNotEqualStencilOpenGLRenderersDemo::dispose()
    {
    ...
    shared_ptr<Node>
    AlwaysAndNotEqualStencilOpenGLRenderersDemo::getCameraRootNode()
    {
    ...
    void
    AlwaysAndNotEqualStencilOpenGLRenderersDemo::init()
    {
