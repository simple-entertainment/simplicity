 ...
 * @author Gary Buyn
 */
public class FacesHandler extends AbstractHandler
{
    /**
     * Creates an instance of <code>FacesHandler</code>.
     */
    public FacesHandler()
    {}
    ...
    public Object execute(final ExecutionEvent event) throws ExecutionException
    {
        ...
        renderers.get(0).setDrawingMode(DrawingMode.FACES);
        renderers.get(1).setDrawingMode(DrawingMode.FACES);
