 ...
 * @author Gary Buyn
 */
public class ModelLoadingVisualSceneEditor extends VisualSceneEditor
{
    /**
     * <p>
     ...
     * </p>
     */
    public ModelLoadingVisualSceneEditor()
    {
        super();
    }
    ...
    public Scene loadScene(final IEditorInput input) throws PartInitException
    {
        ...
        try
        {
            ...
            modelNode.setModel(ModelFactory.loadFromSource(fileInput.getFile().getContents()));
        }
        catch (Exception e)
        {
