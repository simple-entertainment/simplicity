...
namespace simplicity
{
    ...
    class RenderingEngine : public Engine
    {
        public:
             ...
             */
            void
            addRenderer(const int index, Renderer* const renderer);
             ...
             */
            EngineInput*
            advance(EngineInput* const engineInput);
             ...
             */
            Node*
            getRendererRoot(Renderer* const renderer);
             ...
             */
            void
            setRendererRoot(Renderer* const renderer, Node* const root);
