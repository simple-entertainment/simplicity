...
namespace simplicity
{
   ...
   */
  template<class Data>
    class SimpleRGBAColourVector4 : public SimpleVector4<Data> , public RGBAColourVector<Data>
    {
      public:
        /**
         * <p>
         ...
         */
        SimpleRGBAColourVector4(boost::array<Data, SimpleVector4<Data>::CELLS_IN_VECTOR> data);
