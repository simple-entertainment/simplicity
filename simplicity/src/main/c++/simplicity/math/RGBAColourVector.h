...
namespace simplicity
{
	...
	class RGBAColourVector : public virtual Vector<Data, Size>
	{
		public:
			 ...
			 */
			virtual void setAlpha(const Data alpha) = 0;
			 ...
			 */
			virtual void setBlue(const Data blue) = 0;
			 ...
			 */
			virtual void setGreen(const Data green) = 0;
			 ...
			 */
			virtual void setRed(const Data red) = 0;
	};
}
