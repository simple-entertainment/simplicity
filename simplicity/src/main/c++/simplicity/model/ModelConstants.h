...
namespace simplicity
{
	...
	namespace model_constants
	{
		 ...
		 * </p>
		 */
		const int ITEMS_IN_CNV = 3;

		/**
		 * <p>
		 * The number of data items in a texture coordinate array required to represent one vertex.
		 * </p>
		 */
		const int ITEMS_IN_TC = 2;
		 ...
		 * </p>
		 */
		const int VERTICES_IN_A_FACE = 3;
		 ...
		 * </p>
		 */
		const int CNV_ITEMS_IN_FACE = VERTICES_IN_A_FACE * ITEMS_IN_CNV;
	}
}
