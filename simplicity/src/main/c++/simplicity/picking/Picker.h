...
namespace simplicity
{
	/**
	 * <p>
	 * Picks {@link simplicity::Scene Scene}s. The <code>Scene</code> is picked based on a
	 * {@link simplicity::Camera Camera} and a {@link simplicity::Pick Pick} that generally represents a subset of the
	 * <code>Camera</code>'s frame.
	 * </p>
	 *
	 * @author Gary Buyn
	 */
	class Picker
	{
		public:
			...
			/**
			 * <p>
			 * Retrieves the {@link simplicity::DrawingMode DrawingMode} used to create
			 ...
			 */
			virtual Renderer::DrawingMode getDrawingMode() const = 0;
			 ...
			 */
			virtual void setDrawingMode(const Renderer::DrawingMode mode) = 0;
	};
}
