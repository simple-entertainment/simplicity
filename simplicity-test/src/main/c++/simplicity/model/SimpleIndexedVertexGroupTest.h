 ...
 */
#ifndef SIMPLEINDEXEDVERTEXGROUPTEST_H_
#define SIMPLEINDEXEDVERTEXGROUPTEST_H_
...
{
	class SimpleIndexedVertexGroupTest : public testing::Test
	{
		protected:
			/**
			 * An instance of the class being unit tested.
			 */
			SimpleIndexedVertexGroup objectUnderTest;
			...
			void SetUp()
			{
				...
				objectUnderTest.setIndices(indicesVector);
			}
	};
}

#endif /* SIMPLEINDEXEDVERTEXGROUPTEST_H_ */
