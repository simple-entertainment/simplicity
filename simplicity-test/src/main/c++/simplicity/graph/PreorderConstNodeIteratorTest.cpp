...
#include "PreorderConstNodeIteratorTest.h"
...
namespace simplicity
{
	 ...
	 * </p>
	 */
	TEST_F(PreorderConstNodeIteratorTest, iterationFull)
	{
		NodeHierarchy nodes;
		nodes.setStandardNodeHierarchy();

		PreorderConstNodeIterator objectUnderTest(nodes.node1);
		const Node* nextNode;
	 ...
	 * </p>
	 */
	TEST_F(PreorderConstNodeIteratorTest, iterationRootOnly)
	{
		SimpleTreeNode node1;
		PreorderConstNodeIterator objectUnderTest(node1);
		const Node* nextNode;
