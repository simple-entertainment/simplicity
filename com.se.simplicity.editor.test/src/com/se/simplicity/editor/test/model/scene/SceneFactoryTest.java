...
/**
 * <p>
 * Unit tests for the class {@link com.se.simplicity.editor.model.scene.SceneFactory SceneFactory}.
 * </p>
 * 
 * @author Gary Buyn
 */
public class SceneFactoryTest
{
    /**
     * <p>
     * Unit test the method {@link com.se.simplicity.editor.model.scene.SceneFactory.loadFromSourceFile loadFromSourceFile()}.
     * </p>
     * 
     * @throws Exception Thrown when the call to <code>loadFromSourceFile()</code> fails.
     */
    @Test
    public void loadFromSourceFile() throws Exception
    {
        Scene scene = SceneFactory.loadFromSourceFile(new File("src/com/se/simplicity/editor/test/model/scene/triangle.xml"));
     ...
     */
    @Test
    public void loadFromSourceFileCameraNoClass() throws Exception
    {
        try
        {
            SceneFactory.loadFromSourceFile(new File("src/com/se/simplicity/editor/test/model/scene/triangleCameraNoClass.xml"));
        }
        catch (IllegalArgumentException e)
        {
            assertEquals("Camera definitions must specify a class.", e.getMessage());
        }
    }
     ...
     */
    @Test
    public void loadFromSourceFileLightNoClass() throws Exception
    {
        try
        {
            SceneFactory.loadFromSourceFile(new File("src/com/se/simplicity/editor/test/model/scene/triangleLightNoClass.xml"));
        }
        catch (IllegalArgumentException e)
        {
            assertEquals("Light definitions must specify a class.", e.getMessage());
        }
    }
     ...
     */
    @Test
    public void loadFromSourceFileNodeNoName() throws Exception
    {
        Scene scene = SceneFactory.loadFromSourceFile(new File("src/com/se/simplicity/editor/test/model/scene/triangleNodeNoName.xml"));
     ...
     */
    @Test
    public void loadFromSourceFileVertexGroupNoClass() throws Exception
    {
        try
        {
            SceneFactory.loadFromSourceFile(new File("src/com/se/simplicity/editor/test/model/scene/triangleVertexGroupNoClass.xml"));
        }
        catch (IllegalArgumentException e)
        {
            assertEquals("Vertex Group definitions must specify a class.", e.getMessage());
        }
    }
}
