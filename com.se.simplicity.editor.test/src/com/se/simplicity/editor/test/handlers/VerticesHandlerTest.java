...
import com.se.simplicity.editor.handlers.VerticesHandler;
...
/**
 * <p>
 * Unit tests for the class {@link com.se.simplicity.editor.handlers.VerticesHandler VerticesHandler}.
 * </p>
 * 
 * @author Gary Buyn
 */
public class VerticesHandlerTest
{
    /**
     * An instance of the class being unit tested.
     */
    private VerticesHandler testObject;
    ...
    public void before()
    {
        testObject = new VerticesHandler();
    }

    /**
     * <p>
     * Unit test the method {@link com.se.simplicity.editor.handlers.VerticesHandler#execute(ExecutionEvent) execute(ExecutionEvent)}.
     * </p>
     * 
    ...
    public void execute() throws ExecutionException
    {
        ...
        mockRenderer0.setDrawingMode(DrawingMode.VERTICES);
        mockRenderer1.setDrawingMode(DrawingMode.VERTICES);
    ...
    /**
     * <p>
     * Unit test the method {@link com.se.simplicity.editor.handlers.VerticesHandler#execute(ExecutionEvent) execute(ExecutionEvent)} with the special
