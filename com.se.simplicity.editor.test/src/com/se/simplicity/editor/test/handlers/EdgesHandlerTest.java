...
import com.se.simplicity.editor.handlers.EdgesHandler;
...
/**
 * <p>
 * Unit tests for the class {@link com.se.simplicity.editor.handlers.EdgesHandler EdgesHandler}.
 * </p>
 * 
 * @author Gary Buyn
 */
public class EdgesHandlerTest
{
    /**
     * An instance of the class being unit tested.
     */
    private EdgesHandler testObject;
    ...
    public void before()
    {
        testObject = new EdgesHandler();
    }

    /**
     * <p>
     * Unit test the method {@link com.se.simplicity.editor.handlers.EdgesHandler#execute(ExecutionEvent) execute(ExecutionEvent)}.
     * </p>
     * 
    ...
    public void execute() throws ExecutionException
    {
        ...
        mockRenderer0.setDrawingMode(DrawingMode.EDGES);
        mockRenderer1.setDrawingMode(DrawingMode.EDGES);
    ...
    /**
     * <p>
     * Unit test the method {@link com.se.simplicity.editor.handlers.EdgesHandler#execute(ExecutionEvent) execute(ExecutionEvent)} with the special
