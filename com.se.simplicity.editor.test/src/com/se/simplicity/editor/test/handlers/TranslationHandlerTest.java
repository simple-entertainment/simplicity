...
/**
 * <p>
 * Unit tests for the class {@link com.se.simplicity.editor.handlers.TranslationHandler TranslationHandler}.
 * </p>
 * 
 * @author Gary Buyn
 */
public class TranslationHandlerTest
{
     ...
     */
    private TranslationHandler testObject;
    ...
    public void before()
    {
        testObject = new TranslationHandler();
    }

    /**
     * <p>
     * Unit test the method {@link com.se.simplicity.editor.handlers.TranslationHandler#execute(ExecutionEvent) execute(ExecutionEvent)}.
     * </p>
     * 
    ...
    /**
     * <p>
     * Unit test the method {@link com.se.simplicity.editor.handlers.TranslationHandler#execute(ExecutionEvent) execute(ExecutionEvent)} with the
