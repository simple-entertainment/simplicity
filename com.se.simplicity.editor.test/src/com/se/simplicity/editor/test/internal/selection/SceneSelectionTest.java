 ...
 */
package com.se.simplicity.editor.test.internal.selection;
...
public class SceneSelectionTest
{
    ...
    /**
     * <p>
     * Unit test the method {@link com.se.simplicity.editor.internal.selection.SceneSelection#getNode() getNode()}.
     * </p>
     */
    @Test
    public void getNode()
    {
        ...
        // Initialise test environment.
        testObject = new SceneSelection(mockCamera, null);

        // Perform test 1 - verify test 1 results.
        assertEquals(mockNode, testObject.getNode());

        // Initialise test environment.
        testObject = new SceneSelection(mockLight, null);

        // Perform test 2 - verify test 2 results.
        assertEquals(mockNode, testObject.getNode());

        // Initialise test environment.
        testObject = new SceneSelection(mockNode, null);
        ...
        // Perform test 4 - verify test 4 results.
        assertEquals(null, testObject.getNode());
    }
